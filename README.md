...
> `.deb`, delivery to a device or a Cydia repository, self-review and Objective-C code are
> written; skills for Swift, SwiftUI and Combine code and a reference for xmake are not yet. No test run
